...
// The ChainScanCursorFunc type is an adapter to allow the use of ordinary function as a Querier.
type ChainScanCursorFunc func(context.Context, *ent.ChainScanCursorQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ChainScanCursorFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ChainScanCursorQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ChainScanCursorQuery", q)
}

// The TraverseChainScanCursor type is an adapter to allow the use of ordinary function as Traverser.
type TraverseChainScanCursor func(context.Context, *ent.ChainScanCursorQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseChainScanCursor) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseChainScanCursor) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ChainScanCursorQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ChainScanCursorQuery", q)
}
...
// The EthereumGasFundingFunc type is an adapter to allow the use of ordinary function as a Querier.
type EthereumGasFundingFunc func(context.Context, *ent.EthereumGasFundingQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f EthereumGasFundingFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.EthereumGasFundingQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.EthereumGasFundingQuery", q)
}

// The TraverseEthereumGasFunding type is an adapter to allow the use of ordinary function as Traverser.
type TraverseEthereumGasFunding func(context.Context, *ent.EthereumGasFundingQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseEthereumGasFunding) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseEthereumGasFunding) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EthereumGasFundingQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.EthereumGasFundingQuery", q)
}

// The EthereumNonceStateFunc type is an adapter to allow the use of ordinary function as a Querier.
type EthereumNonceStateFunc func(context.Context, *ent.EthereumNonceStateQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f EthereumNonceStateFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.EthereumNonceStateQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.EthereumNonceStateQuery", q)
}

// The TraverseEthereumNonceState type is an adapter to allow the use of ordinary function as Traverser.
type TraverseEthereumNonceState func(context.Context, *ent.EthereumNonceStateQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseEthereumNonceState) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseEthereumNonceState) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EthereumNonceStateQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.EthereumNonceStateQuery", q)
}
...
// The OnchainPaymentIntentFunc type is an adapter to allow the use of ordinary function as a Querier.
type OnchainPaymentIntentFunc func(context.Context, *ent.OnchainPaymentIntentQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f OnchainPaymentIntentFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.OnchainPaymentIntentQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.OnchainPaymentIntentQuery", q)
}

// The TraverseOnchainPaymentIntent type is an adapter to allow the use of ordinary function as Traverser.
type TraverseOnchainPaymentIntent func(context.Context, *ent.OnchainPaymentIntentQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseOnchainPaymentIntent) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseOnchainPaymentIntent) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.OnchainPaymentIntentQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.OnchainPaymentIntentQuery", q)
}
...
// The WalletDerivationCursorFunc type is an adapter to allow the use of ordinary function as a Querier.
type WalletDerivationCursorFunc func(context.Context, *ent.WalletDerivationCursorQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f WalletDerivationCursorFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.WalletDerivationCursorQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.WalletDerivationCursorQuery", q)
}

// The TraverseWalletDerivationCursor type is an adapter to allow the use of ordinary function as Traverser.
type TraverseWalletDerivationCursor func(context.Context, *ent.WalletDerivationCursorQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseWalletDerivationCursor) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseWalletDerivationCursor) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.WalletDerivationCursorQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.WalletDerivationCursorQuery", q)
}

// The WalletSweepFunc type is an adapter to allow the use of ordinary function as a Querier.
type WalletSweepFunc func(context.Context, *ent.WalletSweepQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f WalletSweepFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.WalletSweepQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.WalletSweepQuery", q)
}

// The TraverseWalletSweep type is an adapter to allow the use of ordinary function as Traverser.
type TraverseWalletSweep func(context.Context, *ent.WalletSweepQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseWalletSweep) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseWalletSweep) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.WalletSweepQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.WalletSweepQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.ChainScanCursorQuery:
		return &query[*ent.ChainScanCursorQuery, predicate.ChainScanCursor, chainscancursor.OrderOption]{typ: ent.TypeChainScanCursor, tq: q}, nil
	...
	case *ent.EthereumGasFundingQuery:
		return &query[*ent.EthereumGasFundingQuery, predicate.EthereumGasFunding, ethereumgasfunding.OrderOption]{typ: ent.TypeEthereumGasFunding, tq: q}, nil
	case *ent.EthereumNonceStateQuery:
		return &query[*ent.EthereumNonceStateQuery, predicate.EthereumNonceState, ethereumnoncestate.OrderOption]{typ: ent.TypeEthereumNonceState, tq: q}, nil
	case *ent.GroupQuery:
	...
	case *ent.OnchainPaymentIntentQuery:
		return &query[*ent.OnchainPaymentIntentQuery, predicate.OnchainPaymentIntent, onchainpaymentintent.OrderOption]{typ: ent.TypeOnchainPaymentIntent, tq: q}, nil
	...
	case *ent.WalletDerivationCursorQuery:
		return &query[*ent.WalletDerivationCursorQuery, predicate.WalletDerivationCursor, walletderivationcursor.OrderOption]{typ: ent.TypeWalletDerivationCursor, tq: q}, nil
	case *ent.WalletSweepQuery:
		return &query[*ent.WalletSweepQuery, predicate.WalletSweep, walletsweep.OrderOption]{typ: ent.TypeWalletSweep, tq: q}, nil
	default:
