...
var (
	...
	// ChainScanCursorsColumns holds the columns for the "chain_scan_cursors" table.
	ChainScanCursorsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "network", Type: field.TypeString, Size: 32},
		{Name: "chain_id", Type: field.TypeInt64},
		{Name: "finalized_height", Type: field.TypeInt64, Default: 0},
		{Name: "finalized_hash", Type: field.TypeString, Size: 128, Default: ""},
		{Name: "lease_owner", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "lease_until", Type: field.TypeTime, Nullable: true},
		{Name: "health", Type: field.TypeString, Size: 32, Default: "PAUSED"},
		{Name: "last_success_at", Type: field.TypeTime, Nullable: true},
		{Name: "last_error_code", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "last_error_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "version", Type: field.TypeInt, Default: 0},
	}
	// ChainScanCursorsTable holds the schema information for the "chain_scan_cursors" table.
	ChainScanCursorsTable = &schema.Table{
		Name:       "chain_scan_cursors",
		Columns:    ChainScanCursorsColumns,
		PrimaryKey: []*schema.Column{ChainScanCursorsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "chainscancursor_network",
				Unique:  true,
				Columns: []*schema.Column{ChainScanCursorsColumns[3]},
			},
			{
				Name:    "chainscancursor_lease_until",
				Unique:  false,
				Columns: []*schema.Column{ChainScanCursorsColumns[8]},
			},
			{
				Name:    "chainscancursor_health_updated_at",
				Unique:  false,
				Columns: []*schema.Column{ChainScanCursorsColumns[9], ChainScanCursorsColumns[2]},
			},
		},
	}
	...
	// EthereumGasFundingsColumns holds the columns for the "ethereum_gas_fundings" table.
	EthereumGasFundingsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "chain_id", Type: field.TypeInt64},
		{Name: "sponsor_address", Type: field.TypeString, Size: 64},
		{Name: "target_address", Type: field.TypeString, Size: 64},
		{Name: "derivation_index", Type: field.TypeInt64},
		{Name: "amount_wei", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "idempotency_key", Type: field.TypeString, Size: 128},
		{Name: "signer_request_digest", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "signer_audit_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "nonce", Type: field.TypeInt64},
		{Name: "gas_limit", Type: field.TypeInt64},
		{Name: "max_fee_per_gas_wei", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "max_priority_fee_per_gas_wei", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "transaction_hash", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "replacement_of_id", Type: field.TypeInt64, Nullable: true},
		{Name: "status", Type: field.TypeString, Size: 32, Default: "PREPARED"},
		{Name: "finalized", Type: field.TypeBool, Default: false},
		{Name: "finalized_block_height", Type: field.TypeInt64, Nullable: true},
		{Name: "finalized_block_hash", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "actual_fee_wei", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "retry_count", Type: field.TypeInt, Default: 0},
		{Name: "failure_code", Type: field.TypeString, Nullable: true, Size: 128},
		...
		{Name: "version", Type: field.TypeInt, Default: 0},
		{Name: "intent_id", Type: field.TypeInt64},
	}
	// EthereumGasFundingsTable holds the schema information for the "ethereum_gas_fundings" table.
	EthereumGasFundingsTable = &schema.Table{
		Name:       "ethereum_gas_fundings",
		Columns:    EthereumGasFundingsColumns,
		PrimaryKey: []*schema.Column{EthereumGasFundingsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "ethereum_gas_fundings_onchain_payment_intents_ethereum_gas_fundings",
				Columns:    []*schema.Column{EthereumGasFundingsColumns[28]},
				RefColumns: []*schema.Column{OnchainPaymentIntentsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "ethereumgasfunding_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{EthereumGasFundingsColumns[8]},
			},
			{
				Name:    "ethereumgasfunding_chain_id_sponsor_address_nonce",
				Unique:  false,
				Columns: []*schema.Column{EthereumGasFundingsColumns[3], EthereumGasFundingsColumns[4], EthereumGasFundingsColumns[11]},
			},
			{
				Name:    "ethereumgasfunding_chain_id_target_address_status",
				Unique:  false,
				Columns: []*schema.Column{EthereumGasFundingsColumns[3], EthereumGasFundingsColumns[5], EthereumGasFundingsColumns[17]},
			},
			{
				Name:    "ethereumgasfunding_transaction_hash",
				Unique:  true,
				Columns: []*schema.Column{EthereumGasFundingsColumns[15]},
				Annotation: &entsql.IndexAnnotation{
					Where: "transaction_hash IS NOT NULL AND transaction_hash <> ''",
				},
			},
			{
				Name:    "ethereumgasfunding_status_next_attempt_at",
				Unique:  false,
				Columns: []*schema.Column{EthereumGasFundingsColumns[17], EthereumGasFundingsColumns[25]},
			},
			{
				Name:    "ethereumgasfunding_replacement_of_id",
				Unique:  false,
				Columns: []*schema.Column{EthereumGasFundingsColumns[16]},
			},
		},
	}
	// EthereumNonceStatesColumns holds the columns for the "ethereum_nonce_states" table.
	EthereumNonceStatesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "chain_id", Type: field.TypeInt64},
		{Name: "sender_address", Type: field.TypeString, Size: 64},
		{Name: "next_nonce", Type: field.TypeInt64, Default: 0},
		{Name: "observed_pending_nonce", Type: field.TypeInt64, Default: 0},
		{Name: "status", Type: field.TypeString, Size: 32, Default: "RECONCILING"},
		{Name: "lease_owner", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "lease_until", Type: field.TypeTime, Nullable: true},
	...
	// EthereumNonceStatesTable holds the schema information for the "ethereum_nonce_states" table.
	EthereumNonceStatesTable = &schema.Table{
		Name:       "ethereum_nonce_states",
		Columns:    EthereumNonceStatesColumns,
		PrimaryKey: []*schema.Column{EthereumNonceStatesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "ethereumnoncestate_chain_id_sender_address",
				Unique:  true,
				Columns: []*schema.Column{EthereumNonceStatesColumns[3], EthereumNonceStatesColumns[4]},
			},
			{
				Name:    "ethereumnoncestate_status_lease_until",
				Unique:  false,
				Columns: []*schema.Column{EthereumNonceStatesColumns[7], EthereumNonceStatesColumns[9]},
			},
		},
	}
	...
	OnchainDepositsColumns = []*schema.Column{
		...
		{Name: "transaction_index", Type: field.TypeInt64, Default: 0},
		{Name: "block_height", Type: field.TypeInt64},
		{Name: "block_hash", Type: field.TypeString, Size: 128},
		{Name: "token_contract", Type: field.TypeString, Size: 128},
		{Name: "from_address", Type: field.TypeString, Size: 128},
		{Name: "to_address", Type: field.TypeString, Size: 128},
		{Name: "amount_raw", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "transaction_time", Type: field.TypeTime},
		{Name: "receipt_success", Type: field.TypeBool},
		{Name: "finalized", Type: field.TypeBool, Default: true},
		{Name: "status", Type: field.TypeString, Size: 32, Default: "CONFIRMED"},
		{Name: "validation_error", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "credit_audit_ref", Type: field.TypeString, Nullable: true, Size: 128},
	...
	OnchainDepositsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "onchain_deposits_onchain_payment_intents_deposits",
				Columns:    []*schema.Column{OnchainDepositsColumns[24]},
				RefColumns: []*schema.Column{OnchainPaymentIntentsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "onchaindeposit_network_transaction_id_log_index",
				Unique:  true,
				Columns: []*schema.Column{OnchainDepositsColumns[5], OnchainDepositsColumns[7], OnchainDepositsColumns[8]},
			},
			{
				Name:    "onchaindeposit_intent_id_status",
				Unique:  false,
				Columns: []*schema.Column{OnchainDepositsColumns[24], OnchainDepositsColumns[19]},
			},
			{
				Name:    "onchaindeposit_payment_order_id",
				Unique:  false,
				Columns: []*schema.Column{OnchainDepositsColumns[3]},
			},
			{
				Name:    "onchaindeposit_user_id_transaction_time",
				Unique:  false,
				Columns: []*schema.Column{OnchainDepositsColumns[4], OnchainDepositsColumns[16]},
			},
			{
				Name:    "onchaindeposit_network_block_height_transaction_index_log_index",
				Unique:  false,
				Columns: []*schema.Column{OnchainDepositsColumns[5], OnchainDepositsColumns[10], OnchainDepositsColumns[9], OnchainDepositsColumns[8]},
			},
			{
				Name:    "onchaindeposit_network_to_address",
				Unique:  false,
				Columns: []*schema.Column{OnchainDepositsColumns[5], OnchainDepositsColumns[14]},
			},
			{
				Name:    "onchaindeposit_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{OnchainDepositsColumns[19], OnchainDepositsColumns[1]},
			},
		},
	}
	// OnchainPaymentIntentsColumns holds the columns for the "onchain_payment_intents" table.
	OnchainPaymentIntentsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "user_id", Type: field.TypeInt64},
		...
		{Name: "chain_id", Type: field.TypeInt64},
		{Name: "token_contract", Type: field.TypeString, Size: 128},
		{Name: "deposit_address", Type: field.TypeString, Size: 128},
		{Name: "derivation_index", Type: field.TypeInt64},
		{Name: "expected_amount_raw", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "received_amount_raw", Type: field.TypeString, Default: "0", SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "credited_amount_raw", Type: field.TypeString, Default: "0", SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "overpaid_amount_raw", Type: field.TypeString, Default: "0", SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		...
		{Name: "settlement_idempotency_key", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "settlement_attempts", Type: field.TypeInt, Default: 0},
		{Name: "next_settlement_at", Type: field.TypeTime, Nullable: true},
		{Name: "last_error_code", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "last_error_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
	...
	// OnchainPaymentIntentsTable holds the schema information for the "onchain_payment_intents" table.
	OnchainPaymentIntentsTable = &schema.Table{
		Name:       "onchain_payment_intents",
		Columns:    OnchainPaymentIntentsColumns,
		PrimaryKey: []*schema.Column{OnchainPaymentIntentsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "onchain_payment_intents_payment_orders_onchain_payment_intent",
				Columns:    []*schema.Column{OnchainPaymentIntentsColumns[23]},
		...
		Indexes: []*schema.Index{
			{
				Name:    "onchainpaymentintent_payment_order_id",
				Unique:  true,
				Columns: []*schema.Column{OnchainPaymentIntentsColumns[23]},
			},
			{
				Name:    "onchainpaymentintent_network_derivation_index",
				Unique:  true,
				Columns: []*schema.Column{OnchainPaymentIntentsColumns[4], OnchainPaymentIntentsColumns[8]},
			},
			{
				Name:    "onchainpaymentintent_network_deposit_address",
				Unique:  true,
				Columns: []*schema.Column{OnchainPaymentIntentsColumns[4], OnchainPaymentIntentsColumns[7]},
			},
			{
				Name:    "onchainpaymentintent_settlement_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{OnchainPaymentIntentsColumns[16]},
				Annotation: &entsql.IndexAnnotation{
					Where: "settlement_idempotency_key IS NOT NULL AND settlement_idempotency_key <> ''",
				},
			},
			{
				Name:    "onchainpaymentintent_user_id_status",
				Unique:  false,
				Columns: []*schema.Column{OnchainPaymentIntentsColumns[3], OnchainPaymentIntentsColumns[15]},
			},
			{
				Name:    "onchainpaymentintent_status_next_settlement_at",
				Unique:  false,
				Columns: []*schema.Column{OnchainPaymentIntentsColumns[15], OnchainPaymentIntentsColumns[18]},
			},
		},
	}
	...
	// WalletDerivationCursorsColumns holds the columns for the "wallet_derivation_cursors" table.
	WalletDerivationCursorsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "network", Type: field.TypeString, Size: 32},
	...
	// WalletDerivationCursorsTable holds the schema information for the "wallet_derivation_cursors" table.
	WalletDerivationCursorsTable = &schema.Table{
		Name:       "wallet_derivation_cursors",
		Columns:    WalletDerivationCursorsColumns,
		PrimaryKey: []*schema.Column{WalletDerivationCursorsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "walletderivationcursor_network",
				Unique:  true,
				Columns: []*schema.Column{WalletDerivationCursorsColumns[3]},
			},
		},
	}
	// WalletSweepsColumns holds the columns for the "wallet_sweeps" table.
	WalletSweepsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "network", Type: field.TypeString, Size: 32},
		{Name: "chain_id", Type: field.TypeInt64},
		{Name: "source_address", Type: field.TypeString, Size: 128},
		{Name: "destination_address", Type: field.TypeString, Size: 128},
		{Name: "balance_snapshot_raw", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "amount_raw", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "idempotency_key", Type: field.TypeString, Size: 128},
		{Name: "signer_request_digest", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "signer_audit_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "transaction_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "nonce", Type: field.TypeInt64, Nullable: true},
		{Name: "replacement_of_id", Type: field.TypeInt64, Nullable: true},
		{Name: "fee_raw", Type: field.TypeString, Default: "0", SchemaType: map[string]string{"postgres": "numeric(78,0)"}},
		{Name: "energy_used", Type: field.TypeInt64, Default: 0},
		{Name: "bandwidth_used", Type: field.TypeInt64, Default: 0},
		{Name: "finalized_block_height", Type: field.TypeInt64, Nullable: true},
		{Name: "finalized_block_hash", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "status", Type: field.TypeString, Size: 32, Default: "PREPARED"},
		{Name: "retry_count", Type: field.TypeInt, Default: 0},
	...
	// WalletSweepsTable holds the schema information for the "wallet_sweeps" table.
	WalletSweepsTable = &schema.Table{
		Name:       "wallet_sweeps",
		Columns:    WalletSweepsColumns,
		PrimaryKey: []*schema.Column{WalletSweepsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "wallet_sweeps_onchain_payment_intents_wallet_sweeps",
				Columns:    []*schema.Column{WalletSweepsColumns[27]},
				RefColumns: []*schema.Column{OnchainPaymentIntentsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "walletsweep_idempotency_key",
				Unique:  true,
				Columns: []*schema.Column{WalletSweepsColumns[9]},
			},
			{
				Name:    "walletsweep_network_source_address_status",
				Unique:  false,
				Columns: []*schema.Column{WalletSweepsColumns[3], WalletSweepsColumns[5], WalletSweepsColumns[20]},
			},
			{
				Name:    "walletsweep_network_transaction_id",
				Unique:  true,
				Columns: []*schema.Column{WalletSweepsColumns[3], WalletSweepsColumns[12]},
				Annotation: &entsql.IndexAnnotation{
					Where: "transaction_id IS NOT NULL AND transaction_id <> ''",
				},
			},
			{
				Name:    "walletsweep_status_next_attempt_at",
				Unique:  false,
				Columns: []*schema.Column{WalletSweepsColumns[20], WalletSweepsColumns[24]},
			},
			{
				Name:    "walletsweep_replacement_of_id",
				Unique:  false,
				Columns: []*schema.Column{WalletSweepsColumns[14]},
			},
		},
	}
	...
	Tables = []*schema.Table{
		...
		EthereumGasFundingsTable,
		EthereumNonceStatesTable,
		GroupsTable,
		IdempotencyRecordsTable,
		IdentityAdoptionDecisionsTable,
		OnchainDepositsTable,
		OnchainPaymentIntentsTable,
...
func init() {
	...
	ChainScanCursorsTable.Annotation = &entsql.Annotation{
	...
	EthereumGasFundingsTable.ForeignKeys[0].RefTable = OnchainPaymentIntentsTable
	EthereumGasFundingsTable.Annotation = &entsql.Annotation{
		Table: "ethereum_gas_fundings",
	}
	EthereumNonceStatesTable.Annotation = &entsql.Annotation{
	...
	OnchainDepositsTable.ForeignKeys[0].RefTable = OnchainPaymentIntentsTable
	OnchainDepositsTable.Annotation = &entsql.Annotation{
		Table: "onchain_deposits",
	}
	OnchainPaymentIntentsTable.ForeignKeys[0].RefTable = PaymentOrdersTable
	OnchainPaymentIntentsTable.Annotation = &entsql.Annotation{
	...
	WalletDerivationCursorsTable.Annotation = &entsql.Annotation{
		Table: "wallet_derivation_cursors",
	}
	WalletSweepsTable.ForeignKeys[0].RefTable = OnchainPaymentIntentsTable
	WalletSweepsTable.Annotation = &entsql.Annotation{
		Table: "wallet_sweeps",
	}
}
