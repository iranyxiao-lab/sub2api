...
type PaymentOrderEdges struct {
	...
	// OnchainPaymentIntent holds the value of the onchain_payment_intent edge.
	OnchainPaymentIntent *OnchainPaymentIntent `json:"onchain_payment_intent,omitempty"`
...
// OnchainPaymentIntentOrErr returns the OnchainPaymentIntent value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e PaymentOrderEdges) OnchainPaymentIntentOrErr() (*OnchainPaymentIntent, error) {
	if e.OnchainPaymentIntent != nil {
		return e.OnchainPaymentIntent, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: onchainpaymentintent.Label}
	}
	return nil, &NotLoadedError{edge: "onchain_payment_intent"}
}
...
// QueryOnchainPaymentIntent queries the "onchain_payment_intent" edge of the PaymentOrder entity.
func (_m *PaymentOrder) QueryOnchainPaymentIntent() *OnchainPaymentIntentQuery {
	return NewPaymentOrderClient(_m.config).QueryOnchainPaymentIntent(_m)
}
