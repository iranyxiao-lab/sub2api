...
func init() {
	...
	chainscancursorMixin := schema.ChainScanCursor{}.Mixin()
	chainscancursorMixinFields0 := chainscancursorMixin[0].Fields()
	_ = chainscancursorMixinFields0
	chainscancursorFields := schema.ChainScanCursor{}.Fields()
	_ = chainscancursorFields
	// chainscancursorDescCreatedAt is the schema descriptor for created_at field.
	chainscancursorDescCreatedAt := chainscancursorMixinFields0[0].Descriptor()
	// chainscancursor.DefaultCreatedAt holds the default value on creation for the created_at field.
	chainscancursor.DefaultCreatedAt = chainscancursorDescCreatedAt.Default.(func() time.Time)
	// chainscancursorDescUpdatedAt is the schema descriptor for updated_at field.
	chainscancursorDescUpdatedAt := chainscancursorMixinFields0[1].Descriptor()
	// chainscancursor.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	chainscancursor.DefaultUpdatedAt = chainscancursorDescUpdatedAt.Default.(func() time.Time)
	// chainscancursor.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	chainscancursor.UpdateDefaultUpdatedAt = chainscancursorDescUpdatedAt.UpdateDefault.(func() time.Time)
	// chainscancursorDescNetwork is the schema descriptor for network field.
	chainscancursorDescNetwork := chainscancursorFields[0].Descriptor()
	// chainscancursor.NetworkValidator is a validator for the "network" field. It is called by the builders before save.
	chainscancursor.NetworkValidator = chainscancursorDescNetwork.Validators[0].(func(string) error)
	// chainscancursorDescChainID is the schema descriptor for chain_id field.
	chainscancursorDescChainID := chainscancursorFields[1].Descriptor()
	// chainscancursor.ChainIDValidator is a validator for the "chain_id" field. It is called by the builders before save.
	chainscancursor.ChainIDValidator = chainscancursorDescChainID.Validators[0].(func(int64) error)
	// chainscancursorDescFinalizedHeight is the schema descriptor for finalized_height field.
	chainscancursorDescFinalizedHeight := chainscancursorFields[2].Descriptor()
	// chainscancursor.DefaultFinalizedHeight holds the default value on creation for the finalized_height field.
	chainscancursor.DefaultFinalizedHeight = chainscancursorDescFinalizedHeight.Default.(int64)
	// chainscancursor.FinalizedHeightValidator is a validator for the "finalized_height" field. It is called by the builders before save.
	chainscancursor.FinalizedHeightValidator = chainscancursorDescFinalizedHeight.Validators[0].(func(int64) error)
	// chainscancursorDescFinalizedHash is the schema descriptor for finalized_hash field.
	chainscancursorDescFinalizedHash := chainscancursorFields[3].Descriptor()
	// chainscancursor.DefaultFinalizedHash holds the default value on creation for the finalized_hash field.
	chainscancursor.DefaultFinalizedHash = chainscancursorDescFinalizedHash.Default.(string)
	// chainscancursor.FinalizedHashValidator is a validator for the "finalized_hash" field. It is called by the builders before save.
	chainscancursor.FinalizedHashValidator = chainscancursorDescFinalizedHash.Validators[0].(func(string) error)
	// chainscancursorDescLeaseOwner is the schema descriptor for lease_owner field.
	chainscancursorDescLeaseOwner := chainscancursorFields[4].Descriptor()
	// chainscancursor.LeaseOwnerValidator is a validator for the "lease_owner" field. It is called by the builders before save.
	chainscancursor.LeaseOwnerValidator = chainscancursorDescLeaseOwner.Validators[0].(func(string) error)
	// chainscancursorDescHealth is the schema descriptor for health field.
	chainscancursorDescHealth := chainscancursorFields[6].Descriptor()
	// chainscancursor.DefaultHealth holds the default value on creation for the health field.
	chainscancursor.DefaultHealth = chainscancursorDescHealth.Default.(string)
	// chainscancursor.HealthValidator is a validator for the "health" field. It is called by the builders before save.
	chainscancursor.HealthValidator = chainscancursorDescHealth.Validators[0].(func(string) error)
	// chainscancursorDescLastErrorCode is the schema descriptor for last_error_code field.
	chainscancursorDescLastErrorCode := chainscancursorFields[8].Descriptor()
	// chainscancursor.LastErrorCodeValidator is a validator for the "last_error_code" field. It is called by the builders before save.
	chainscancursor.LastErrorCodeValidator = chainscancursorDescLastErrorCode.Validators[0].(func(string) error)
	// chainscancursorDescVersion is the schema descriptor for version field.
	chainscancursorDescVersion := chainscancursorFields[10].Descriptor()
	// chainscancursor.DefaultVersion holds the default value on creation for the version field.
	chainscancursor.DefaultVersion = chainscancursorDescVersion.Default.(int)
	// chainscancursor.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	chainscancursor.VersionValidator = chainscancursorDescVersion.Validators[0].(func(int) error)
	...
	ethereumgasfundingMixin := schema.EthereumGasFunding{}.Mixin()
	ethereumgasfundingMixinFields0 := ethereumgasfundingMixin[0].Fields()
	_ = ethereumgasfundingMixinFields0
	ethereumgasfundingFields := schema.EthereumGasFunding{}.Fields()
	_ = ethereumgasfundingFields
	// ethereumgasfundingDescCreatedAt is the schema descriptor for created_at field.
	ethereumgasfundingDescCreatedAt := ethereumgasfundingMixinFields0[0].Descriptor()
	// ethereumgasfunding.DefaultCreatedAt holds the default value on creation for the created_at field.
	ethereumgasfunding.DefaultCreatedAt = ethereumgasfundingDescCreatedAt.Default.(func() time.Time)
	// ethereumgasfundingDescUpdatedAt is the schema descriptor for updated_at field.
	ethereumgasfundingDescUpdatedAt := ethereumgasfundingMixinFields0[1].Descriptor()
	// ethereumgasfunding.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	ethereumgasfunding.DefaultUpdatedAt = ethereumgasfundingDescUpdatedAt.Default.(func() time.Time)
	// ethereumgasfunding.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	ethereumgasfunding.UpdateDefaultUpdatedAt = ethereumgasfundingDescUpdatedAt.UpdateDefault.(func() time.Time)
	// ethereumgasfundingDescIntentID is the schema descriptor for intent_id field.
	ethereumgasfundingDescIntentID := ethereumgasfundingFields[0].Descriptor()
	// ethereumgasfunding.IntentIDValidator is a validator for the "intent_id" field. It is called by the builders before save.
	ethereumgasfunding.IntentIDValidator = ethereumgasfundingDescIntentID.Validators[0].(func(int64) error)
	// ethereumgasfundingDescChainID is the schema descriptor for chain_id field.
	ethereumgasfundingDescChainID := ethereumgasfundingFields[1].Descriptor()
	// ethereumgasfunding.ChainIDValidator is a validator for the "chain_id" field. It is called by the builders before save.
	ethereumgasfunding.ChainIDValidator = ethereumgasfundingDescChainID.Validators[0].(func(int64) error)
	// ethereumgasfundingDescSponsorAddress is the schema descriptor for sponsor_address field.
	ethereumgasfundingDescSponsorAddress := ethereumgasfundingFields[2].Descriptor()
	// ethereumgasfunding.SponsorAddressValidator is a validator for the "sponsor_address" field. It is called by the builders before save.
	ethereumgasfunding.SponsorAddressValidator = ethereumgasfundingDescSponsorAddress.Validators[0].(func(string) error)
	// ethereumgasfundingDescTargetAddress is the schema descriptor for target_address field.
	ethereumgasfundingDescTargetAddress := ethereumgasfundingFields[3].Descriptor()
	// ethereumgasfunding.TargetAddressValidator is a validator for the "target_address" field. It is called by the builders before save.
	ethereumgasfunding.TargetAddressValidator = ethereumgasfundingDescTargetAddress.Validators[0].(func(string) error)
	// ethereumgasfundingDescDerivationIndex is the schema descriptor for derivation_index field.
	ethereumgasfundingDescDerivationIndex := ethereumgasfundingFields[4].Descriptor()
	// ethereumgasfunding.DerivationIndexValidator is a validator for the "derivation_index" field. It is called by the builders before save.
	ethereumgasfunding.DerivationIndexValidator = ethereumgasfundingDescDerivationIndex.Validators[0].(func(int64) error)
	// ethereumgasfundingDescIdempotencyKey is the schema descriptor for idempotency_key field.
	ethereumgasfundingDescIdempotencyKey := ethereumgasfundingFields[6].Descriptor()
	// ethereumgasfunding.IdempotencyKeyValidator is a validator for the "idempotency_key" field. It is called by the builders before save.
	ethereumgasfunding.IdempotencyKeyValidator = ethereumgasfundingDescIdempotencyKey.Validators[0].(func(string) error)
	// ethereumgasfundingDescSignerRequestDigest is the schema descriptor for signer_request_digest field.
	ethereumgasfundingDescSignerRequestDigest := ethereumgasfundingFields[7].Descriptor()
	// ethereumgasfunding.SignerRequestDigestValidator is a validator for the "signer_request_digest" field. It is called by the builders before save.
	ethereumgasfunding.SignerRequestDigestValidator = ethereumgasfundingDescSignerRequestDigest.Validators[0].(func(string) error)
	// ethereumgasfundingDescSignerAuditID is the schema descriptor for signer_audit_id field.
	ethereumgasfundingDescSignerAuditID := ethereumgasfundingFields[8].Descriptor()
	// ethereumgasfunding.SignerAuditIDValidator is a validator for the "signer_audit_id" field. It is called by the builders before save.
	ethereumgasfunding.SignerAuditIDValidator = ethereumgasfundingDescSignerAuditID.Validators[0].(func(string) error)
	// ethereumgasfundingDescNonce is the schema descriptor for nonce field.
	ethereumgasfundingDescNonce := ethereumgasfundingFields[9].Descriptor()
	// ethereumgasfunding.NonceValidator is a validator for the "nonce" field. It is called by the builders before save.
	ethereumgasfunding.NonceValidator = ethereumgasfundingDescNonce.Validators[0].(func(int64) error)
	// ethereumgasfundingDescGasLimit is the schema descriptor for gas_limit field.
	ethereumgasfundingDescGasLimit := ethereumgasfundingFields[10].Descriptor()
	// ethereumgasfunding.GasLimitValidator is a validator for the "gas_limit" field. It is called by the builders before save.
	ethereumgasfunding.GasLimitValidator = ethereumgasfundingDescGasLimit.Validators[0].(func(int64) error)
	// ethereumgasfundingDescTransactionHash is the schema descriptor for transaction_hash field.
	ethereumgasfundingDescTransactionHash := ethereumgasfundingFields[13].Descriptor()
	// ethereumgasfunding.TransactionHashValidator is a validator for the "transaction_hash" field. It is called by the builders before save.
	ethereumgasfunding.TransactionHashValidator = ethereumgasfundingDescTransactionHash.Validators[0].(func(string) error)
	// ethereumgasfundingDescReplacementOfID is the schema descriptor for replacement_of_id field.
	ethereumgasfundingDescReplacementOfID := ethereumgasfundingFields[14].Descriptor()
	// ethereumgasfunding.ReplacementOfIDValidator is a validator for the "replacement_of_id" field. It is called by the builders before save.
	ethereumgasfunding.ReplacementOfIDValidator = ethereumgasfundingDescReplacementOfID.Validators[0].(func(int64) error)
	// ethereumgasfundingDescStatus is the schema descriptor for status field.
	ethereumgasfundingDescStatus := ethereumgasfundingFields[15].Descriptor()
	// ethereumgasfunding.DefaultStatus holds the default value on creation for the status field.
	ethereumgasfunding.DefaultStatus = ethereumgasfundingDescStatus.Default.(string)
	// ethereumgasfunding.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	ethereumgasfunding.StatusValidator = ethereumgasfundingDescStatus.Validators[0].(func(string) error)
	// ethereumgasfundingDescFinalized is the schema descriptor for finalized field.
	ethereumgasfundingDescFinalized := ethereumgasfundingFields[16].Descriptor()
	// ethereumgasfunding.DefaultFinalized holds the default value on creation for the finalized field.
	ethereumgasfunding.DefaultFinalized = ethereumgasfundingDescFinalized.Default.(bool)
	// ethereumgasfundingDescFinalizedBlockHeight is the schema descriptor for finalized_block_height field.
	ethereumgasfundingDescFinalizedBlockHeight := ethereumgasfundingFields[17].Descriptor()
	// ethereumgasfunding.FinalizedBlockHeightValidator is a validator for the "finalized_block_height" field. It is called by the builders before save.
	ethereumgasfunding.FinalizedBlockHeightValidator = ethereumgasfundingDescFinalizedBlockHeight.Validators[0].(func(int64) error)
	// ethereumgasfundingDescFinalizedBlockHash is the schema descriptor for finalized_block_hash field.
	ethereumgasfundingDescFinalizedBlockHash := ethereumgasfundingFields[18].Descriptor()
	// ethereumgasfunding.FinalizedBlockHashValidator is a validator for the "finalized_block_hash" field. It is called by the builders before save.
	ethereumgasfunding.FinalizedBlockHashValidator = ethereumgasfundingDescFinalizedBlockHash.Validators[0].(func(string) error)
	// ethereumgasfundingDescRetryCount is the schema descriptor for retry_count field.
	ethereumgasfundingDescRetryCount := ethereumgasfundingFields[20].Descriptor()
	// ethereumgasfunding.DefaultRetryCount holds the default value on creation for the retry_count field.
	ethereumgasfunding.DefaultRetryCount = ethereumgasfundingDescRetryCount.Default.(int)
	// ethereumgasfunding.RetryCountValidator is a validator for the "retry_count" field. It is called by the builders before save.
	ethereumgasfunding.RetryCountValidator = ethereumgasfundingDescRetryCount.Validators[0].(func(int) error)
	// ethereumgasfundingDescFailureCode is the schema descriptor for failure_code field.
	ethereumgasfundingDescFailureCode := ethereumgasfundingFields[21].Descriptor()
	// ethereumgasfunding.FailureCodeValidator is a validator for the "failure_code" field. It is called by the builders before save.
	ethereumgasfunding.FailureCodeValidator = ethereumgasfundingDescFailureCode.Validators[0].(func(string) error)
	// ethereumgasfundingDescVersion is the schema descriptor for version field.
	ethereumgasfundingDescVersion := ethereumgasfundingFields[25].Descriptor()
	// ethereumgasfunding.DefaultVersion holds the default value on creation for the version field.
	ethereumgasfunding.DefaultVersion = ethereumgasfundingDescVersion.Default.(int)
	// ethereumgasfunding.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	ethereumgasfunding.VersionValidator = ethereumgasfundingDescVersion.Validators[0].(func(int) error)
	ethereumnoncestateMixin := schema.EthereumNonceState{}.Mixin()
	ethereumnoncestateMixinFields0 := ethereumnoncestateMixin[0].Fields()
	_ = ethereumnoncestateMixinFields0
	ethereumnoncestateFields := schema.EthereumNonceState{}.Fields()
	_ = ethereumnoncestateFields
	// ethereumnoncestateDescCreatedAt is the schema descriptor for created_at field.
	ethereumnoncestateDescCreatedAt := ethereumnoncestateMixinFields0[0].Descriptor()
	// ethereumnoncestate.DefaultCreatedAt holds the default value on creation for the created_at field.
	ethereumnoncestate.DefaultCreatedAt = ethereumnoncestateDescCreatedAt.Default.(func() time.Time)
	// ethereumnoncestateDescUpdatedAt is the schema descriptor for updated_at field.
	ethereumnoncestateDescUpdatedAt := ethereumnoncestateMixinFields0[1].Descriptor()
	// ethereumnoncestate.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	ethereumnoncestate.DefaultUpdatedAt = ethereumnoncestateDescUpdatedAt.Default.(func() time.Time)
	// ethereumnoncestate.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	ethereumnoncestate.UpdateDefaultUpdatedAt = ethereumnoncestateDescUpdatedAt.UpdateDefault.(func() time.Time)
	// ethereumnoncestateDescChainID is the schema descriptor for chain_id field.
	ethereumnoncestateDescChainID := ethereumnoncestateFields[0].Descriptor()
	// ethereumnoncestate.ChainIDValidator is a validator for the "chain_id" field. It is called by the builders before save.
	ethereumnoncestate.ChainIDValidator = ethereumnoncestateDescChainID.Validators[0].(func(int64) error)
	// ethereumnoncestateDescSenderAddress is the schema descriptor for sender_address field.
	ethereumnoncestateDescSenderAddress := ethereumnoncestateFields[1].Descriptor()
	// ethereumnoncestate.SenderAddressValidator is a validator for the "sender_address" field. It is called by the builders before save.
	ethereumnoncestate.SenderAddressValidator = ethereumnoncestateDescSenderAddress.Validators[0].(func(string) error)
	// ethereumnoncestateDescNextNonce is the schema descriptor for next_nonce field.
	ethereumnoncestateDescNextNonce := ethereumnoncestateFields[2].Descriptor()
	// ethereumnoncestate.DefaultNextNonce holds the default value on creation for the next_nonce field.
	ethereumnoncestate.DefaultNextNonce = ethereumnoncestateDescNextNonce.Default.(int64)
	// ethereumnoncestate.NextNonceValidator is a validator for the "next_nonce" field. It is called by the builders before save.
	ethereumnoncestate.NextNonceValidator = ethereumnoncestateDescNextNonce.Validators[0].(func(int64) error)
	// ethereumnoncestateDescObservedPendingNonce is the schema descriptor for observed_pending_nonce field.
	ethereumnoncestateDescObservedPendingNonce := ethereumnoncestateFields[3].Descriptor()
	// ethereumnoncestate.DefaultObservedPendingNonce holds the default value on creation for the observed_pending_nonce field.
	ethereumnoncestate.DefaultObservedPendingNonce = ethereumnoncestateDescObservedPendingNonce.Default.(int64)
	// ethereumnoncestate.ObservedPendingNonceValidator is a validator for the "observed_pending_nonce" field. It is called by the builders before save.
	ethereumnoncestate.ObservedPendingNonceValidator = ethereumnoncestateDescObservedPendingNonce.Validators[0].(func(int64) error)
	// ethereumnoncestateDescStatus is the schema descriptor for status field.
	ethereumnoncestateDescStatus := ethereumnoncestateFields[4].Descriptor()
	// ethereumnoncestate.DefaultStatus holds the default value on creation for the status field.
	ethereumnoncestate.DefaultStatus = ethereumnoncestateDescStatus.Default.(string)
	// ethereumnoncestate.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	ethereumnoncestate.StatusValidator = ethereumnoncestateDescStatus.Validators[0].(func(string) error)
	// ethereumnoncestateDescLeaseOwner is the schema descriptor for lease_owner field.
	ethereumnoncestateDescLeaseOwner := ethereumnoncestateFields[5].Descriptor()
	// ethereumnoncestate.LeaseOwnerValidator is a validator for the "lease_owner" field. It is called by the builders before save.
	ethereumnoncestate.LeaseOwnerValidator = ethereumnoncestateDescLeaseOwner.Validators[0].(func(string) error)
	// ethereumnoncestateDescLastErrorCode is the schema descriptor for last_error_code field.
	ethereumnoncestateDescLastErrorCode := ethereumnoncestateFields[8].Descriptor()
	// ethereumnoncestate.LastErrorCodeValidator is a validator for the "last_error_code" field. It is called by the builders before save.
	ethereumnoncestate.LastErrorCodeValidator = ethereumnoncestateDescLastErrorCode.Validators[0].(func(string) error)
	// ethereumnoncestateDescVersion is the schema descriptor for version field.
	ethereumnoncestateDescVersion := ethereumnoncestateFields[10].Descriptor()
	// ethereumnoncestate.DefaultVersion holds the default value on creation for the version field.
	ethereumnoncestate.DefaultVersion = ethereumnoncestateDescVersion.Default.(int)
	// ethereumnoncestate.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	ethereumnoncestate.VersionValidator = ethereumnoncestateDescVersion.Validators[0].(func(int) error)
	...
	// onchaindepositDescIntentID is the schema descriptor for intent_id field.
	onchaindepositDescIntentID := onchaindepositFields[0].Descriptor()
	// onchaindeposit.IntentIDValidator is a validator for the "intent_id" field. It is called by the builders before save.
	onchaindeposit.IntentIDValidator = onchaindepositDescIntentID.Validators[0].(func(int64) error)
	// onchaindepositDescPaymentOrderID is the schema descriptor for payment_order_id field.
	onchaindepositDescPaymentOrderID := onchaindepositFields[1].Descriptor()
	// onchaindeposit.PaymentOrderIDValidator is a validator for the "payment_order_id" field. It is called by the builders before save.
	onchaindeposit.PaymentOrderIDValidator = onchaindepositDescPaymentOrderID.Validators[0].(func(int64) error)
	// onchaindepositDescUserID is the schema descriptor for user_id field.
	onchaindepositDescUserID := onchaindepositFields[2].Descriptor()
	// onchaindeposit.UserIDValidator is a validator for the "user_id" field. It is called by the builders before save.
	onchaindeposit.UserIDValidator = onchaindepositDescUserID.Validators[0].(func(int64) error)
	// onchaindepositDescNetwork is the schema descriptor for network field.
	onchaindepositDescNetwork := onchaindepositFields[3].Descriptor()
	// onchaindeposit.NetworkValidator is a validator for the "network" field. It is called by the builders before save.
	onchaindeposit.NetworkValidator = onchaindepositDescNetwork.Validators[0].(func(string) error)
	// onchaindepositDescChainID is the schema descriptor for chain_id field.
	onchaindepositDescChainID := onchaindepositFields[4].Descriptor()
	// onchaindeposit.ChainIDValidator is a validator for the "chain_id" field. It is called by the builders before save.
	onchaindeposit.ChainIDValidator = onchaindepositDescChainID.Validators[0].(func(int64) error)
	// onchaindepositDescTransactionID is the schema descriptor for transaction_id field.
	onchaindepositDescTransactionID := onchaindepositFields[5].Descriptor()
	// onchaindeposit.TransactionIDValidator is a validator for the "transaction_id" field. It is called by the builders before save.
	onchaindeposit.TransactionIDValidator = onchaindepositDescTransactionID.Validators[0].(func(string) error)
	// onchaindepositDescLogIndex is the schema descriptor for log_index field.
	onchaindepositDescLogIndex := onchaindepositFields[6].Descriptor()
	// onchaindeposit.LogIndexValidator is a validator for the "log_index" field. It is called by the builders before save.
	onchaindeposit.LogIndexValidator = onchaindepositDescLogIndex.Validators[0].(func(int64) error)
	// onchaindepositDescTransactionIndex is the schema descriptor for transaction_index field.
	onchaindepositDescTransactionIndex := onchaindepositFields[7].Descriptor()
	// onchaindeposit.DefaultTransactionIndex holds the default value on creation for the transaction_index field.
	onchaindeposit.DefaultTransactionIndex = onchaindepositDescTransactionIndex.Default.(int64)
	// onchaindeposit.TransactionIndexValidator is a validator for the "transaction_index" field. It is called by the builders before save.
	onchaindeposit.TransactionIndexValidator = onchaindepositDescTransactionIndex.Validators[0].(func(int64) error)
	// onchaindepositDescBlockHeight is the schema descriptor for block_height field.
	onchaindepositDescBlockHeight := onchaindepositFields[8].Descriptor()
	// onchaindeposit.BlockHeightValidator is a validator for the "block_height" field. It is called by the builders before save.
	onchaindeposit.BlockHeightValidator = onchaindepositDescBlockHeight.Validators[0].(func(int64) error)
	// onchaindepositDescBlockHash is the schema descriptor for block_hash field.
	onchaindepositDescBlockHash := onchaindepositFields[9].Descriptor()
	// onchaindeposit.BlockHashValidator is a validator for the "block_hash" field. It is called by the builders before save.
	onchaindeposit.BlockHashValidator = onchaindepositDescBlockHash.Validators[0].(func(string) error)
	// onchaindepositDescTokenContract is the schema descriptor for token_contract field.
	onchaindepositDescTokenContract := onchaindepositFields[10].Descriptor()
	...
	onchaindeposit.TokenContractValidator = onchaindepositDescTokenContract.Validators[0].(func(string) error)
	// onchaindepositDescFromAddress is the schema descriptor for from_address field.
	onchaindepositDescFromAddress := onchaindepositFields[11].Descriptor()
	// onchaindeposit.FromAddressValidator is a validator for the "from_address" field. It is called by the builders before save.
	onchaindeposit.FromAddressValidator = onchaindepositDescFromAddress.Validators[0].(func(string) error)
	// onchaindepositDescToAddress is the schema descriptor for to_address field.
	onchaindepositDescToAddress := onchaindepositFields[12].Descriptor()
	// onchaindeposit.ToAddressValidator is a validator for the "to_address" field. It is called by the builders before save.
	onchaindeposit.ToAddressValidator = onchaindepositDescToAddress.Validators[0].(func(string) error)
	// onchaindepositDescFinalized is the schema descriptor for finalized field.
	onchaindepositDescFinalized := onchaindepositFields[16].Descriptor()
	// onchaindeposit.DefaultFinalized holds the default value on creation for the finalized field.
	onchaindeposit.DefaultFinalized = onchaindepositDescFinalized.Default.(bool)
	// onchaindepositDescStatus is the schema descriptor for status field.
	onchaindepositDescStatus := onchaindepositFields[17].Descriptor()
	...
	// onchaindepositDescCreditAuditRef is the schema descriptor for credit_audit_ref field.
	onchaindepositDescCreditAuditRef := onchaindepositFields[19].Descriptor()
	// onchaindeposit.CreditAuditRefValidator is a validator for the "credit_audit_ref" field. It is called by the builders before save.
	onchaindeposit.CreditAuditRefValidator = onchaindepositDescCreditAuditRef.Validators[0].(func(string) error)
	// onchaindepositDescVersion is the schema descriptor for version field.
	onchaindepositDescVersion := onchaindepositFields[21].Descriptor()
	// onchaindeposit.DefaultVersion holds the default value on creation for the version field.
	onchaindeposit.DefaultVersion = onchaindepositDescVersion.Default.(int)
	// onchaindeposit.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	onchaindeposit.VersionValidator = onchaindepositDescVersion.Validators[0].(func(int) error)
	onchainpaymentintentMixin := schema.OnchainPaymentIntent{}.Mixin()
	onchainpaymentintentMixinFields0 := onchainpaymentintentMixin[0].Fields()
	_ = onchainpaymentintentMixinFields0
	onchainpaymentintentFields := schema.OnchainPaymentIntent{}.Fields()
	_ = onchainpaymentintentFields
	// onchainpaymentintentDescCreatedAt is the schema descriptor for created_at field.
	onchainpaymentintentDescCreatedAt := onchainpaymentintentMixinFields0[0].Descriptor()
	// onchainpaymentintent.DefaultCreatedAt holds the default value on creation for the created_at field.
	onchainpaymentintent.DefaultCreatedAt = onchainpaymentintentDescCreatedAt.Default.(func() time.Time)
	// onchainpaymentintentDescUpdatedAt is the schema descriptor for updated_at field.
	onchainpaymentintentDescUpdatedAt := onchainpaymentintentMixinFields0[1].Descriptor()
	// onchainpaymentintent.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	onchainpaymentintent.DefaultUpdatedAt = onchainpaymentintentDescUpdatedAt.Default.(func() time.Time)
	// onchainpaymentintent.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	onchainpaymentintent.UpdateDefaultUpdatedAt = onchainpaymentintentDescUpdatedAt.UpdateDefault.(func() time.Time)
	// onchainpaymentintentDescPaymentOrderID is the schema descriptor for payment_order_id field.
	onchainpaymentintentDescPaymentOrderID := onchainpaymentintentFields[0].Descriptor()
	// onchainpaymentintent.PaymentOrderIDValidator is a validator for the "payment_order_id" field. It is called by the builders before save.
	onchainpaymentintent.PaymentOrderIDValidator = onchainpaymentintentDescPaymentOrderID.Validators[0].(func(int64) error)
	// onchainpaymentintentDescUserID is the schema descriptor for user_id field.
	onchainpaymentintentDescUserID := onchainpaymentintentFields[1].Descriptor()
	// onchainpaymentintent.UserIDValidator is a validator for the "user_id" field. It is called by the builders before save.
	onchainpaymentintent.UserIDValidator = onchainpaymentintentDescUserID.Validators[0].(func(int64) error)
	// onchainpaymentintentDescNetwork is the schema descriptor for network field.
	onchainpaymentintentDescNetwork := onchainpaymentintentFields[2].Descriptor()
	// onchainpaymentintent.NetworkValidator is a validator for the "network" field. It is called by the builders before save.
	onchainpaymentintent.NetworkValidator = onchainpaymentintentDescNetwork.Validators[0].(func(string) error)
	// onchainpaymentintentDescChainID is the schema descriptor for chain_id field.
	onchainpaymentintentDescChainID := onchainpaymentintentFields[3].Descriptor()
	// onchainpaymentintent.ChainIDValidator is a validator for the "chain_id" field. It is called by the builders before save.
	onchainpaymentintent.ChainIDValidator = onchainpaymentintentDescChainID.Validators[0].(func(int64) error)
	// onchainpaymentintentDescTokenContract is the schema descriptor for token_contract field.
	onchainpaymentintentDescTokenContract := onchainpaymentintentFields[4].Descriptor()
	// onchainpaymentintent.TokenContractValidator is a validator for the "token_contract" field. It is called by the builders before save.
	onchainpaymentintent.TokenContractValidator = onchainpaymentintentDescTokenContract.Validators[0].(func(string) error)
	// onchainpaymentintentDescDepositAddress is the schema descriptor for deposit_address field.
	onchainpaymentintentDescDepositAddress := onchainpaymentintentFields[5].Descriptor()
	// onchainpaymentintent.DepositAddressValidator is a validator for the "deposit_address" field. It is called by the builders before save.
	onchainpaymentintent.DepositAddressValidator = onchainpaymentintentDescDepositAddress.Validators[0].(func(string) error)
	// onchainpaymentintentDescDerivationIndex is the schema descriptor for derivation_index field.
	onchainpaymentintentDescDerivationIndex := onchainpaymentintentFields[6].Descriptor()
	// onchainpaymentintent.DerivationIndexValidator is a validator for the "derivation_index" field. It is called by the builders before save.
	onchainpaymentintent.DerivationIndexValidator = onchainpaymentintentDescDerivationIndex.Validators[0].(func(int64) error)
	// onchainpaymentintentDescReceivedAmountRaw is the schema descriptor for received_amount_raw field.
	onchainpaymentintentDescReceivedAmountRaw := onchainpaymentintentFields[8].Descriptor()
	// onchainpaymentintent.DefaultReceivedAmountRaw holds the default value on creation for the received_amount_raw field.
	onchainpaymentintent.DefaultReceivedAmountRaw = onchainpaymentintentDescReceivedAmountRaw.Default.(string)
	// onchainpaymentintentDescCreditedAmountRaw is the schema descriptor for credited_amount_raw field.
	onchainpaymentintentDescCreditedAmountRaw := onchainpaymentintentFields[9].Descriptor()
	// onchainpaymentintent.DefaultCreditedAmountRaw holds the default value on creation for the credited_amount_raw field.
	onchainpaymentintent.DefaultCreditedAmountRaw = onchainpaymentintentDescCreditedAmountRaw.Default.(string)
	// onchainpaymentintentDescOverpaidAmountRaw is the schema descriptor for overpaid_amount_raw field.
	onchainpaymentintentDescOverpaidAmountRaw := onchainpaymentintentFields[10].Descriptor()
	// onchainpaymentintent.DefaultOverpaidAmountRaw holds the default value on creation for the overpaid_amount_raw field.
	onchainpaymentintent.DefaultOverpaidAmountRaw = onchainpaymentintentDescOverpaidAmountRaw.Default.(string)
	// onchainpaymentintentDescConfigVersion is the schema descriptor for config_version field.
	onchainpaymentintentDescConfigVersion := onchainpaymentintentFields[12].Descriptor()
	// onchainpaymentintent.ConfigVersionValidator is a validator for the "config_version" field. It is called by the builders before save.
	onchainpaymentintent.ConfigVersionValidator = onchainpaymentintentDescConfigVersion.Validators[0].(func(string) error)
	// onchainpaymentintentDescStatus is the schema descriptor for status field.
	onchainpaymentintentDescStatus := onchainpaymentintentFields[13].Descriptor()
	// onchainpaymentintent.DefaultStatus holds the default value on creation for the status field.
	onchainpaymentintent.DefaultStatus = onchainpaymentintentDescStatus.Default.(string)
	// onchainpaymentintent.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	onchainpaymentintent.StatusValidator = onchainpaymentintentDescStatus.Validators[0].(func(string) error)
	// onchainpaymentintentDescSettlementIdempotencyKey is the schema descriptor for settlement_idempotency_key field.
	onchainpaymentintentDescSettlementIdempotencyKey := onchainpaymentintentFields[14].Descriptor()
	// onchainpaymentintent.SettlementIdempotencyKeyValidator is a validator for the "settlement_idempotency_key" field. It is called by the builders before save.
	onchainpaymentintent.SettlementIdempotencyKeyValidator = onchainpaymentintentDescSettlementIdempotencyKey.Validators[0].(func(string) error)
	// onchainpaymentintentDescSettlementAttempts is the schema descriptor for settlement_attempts field.
	onchainpaymentintentDescSettlementAttempts := onchainpaymentintentFields[15].Descriptor()
	// onchainpaymentintent.DefaultSettlementAttempts holds the default value on creation for the settlement_attempts field.
	onchainpaymentintent.DefaultSettlementAttempts = onchainpaymentintentDescSettlementAttempts.Default.(int)
	// onchainpaymentintent.SettlementAttemptsValidator is a validator for the "settlement_attempts" field. It is called by the builders before save.
	onchainpaymentintent.SettlementAttemptsValidator = onchainpaymentintentDescSettlementAttempts.Validators[0].(func(int) error)
	// onchainpaymentintentDescLastErrorCode is the schema descriptor for last_error_code field.
	onchainpaymentintentDescLastErrorCode := onchainpaymentintentFields[17].Descriptor()
	// onchainpaymentintent.LastErrorCodeValidator is a validator for the "last_error_code" field. It is called by the builders before save.
	onchainpaymentintent.LastErrorCodeValidator = onchainpaymentintentDescLastErrorCode.Validators[0].(func(string) error)
	// onchainpaymentintentDescVersion is the schema descriptor for version field.
	onchainpaymentintentDescVersion := onchainpaymentintentFields[20].Descriptor()
	// onchainpaymentintent.DefaultVersion holds the default value on creation for the version field.
	onchainpaymentintent.DefaultVersion = onchainpaymentintentDescVersion.Default.(int)
	// onchainpaymentintent.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	onchainpaymentintent.VersionValidator = onchainpaymentintentDescVersion.Validators[0].(func(int) error)
	...
	walletderivationcursorMixin := schema.WalletDerivationCursor{}.Mixin()
	walletderivationcursorMixinFields0 := walletderivationcursorMixin[0].Fields()
	_ = walletderivationcursorMixinFields0
	walletderivationcursorFields := schema.WalletDerivationCursor{}.Fields()
	_ = walletderivationcursorFields
	// walletderivationcursorDescCreatedAt is the schema descriptor for created_at field.
	walletderivationcursorDescCreatedAt := walletderivationcursorMixinFields0[0].Descriptor()
	// walletderivationcursor.DefaultCreatedAt holds the default value on creation for the created_at field.
	walletderivationcursor.DefaultCreatedAt = walletderivationcursorDescCreatedAt.Default.(func() time.Time)
	// walletderivationcursorDescUpdatedAt is the schema descriptor for updated_at field.
	walletderivationcursorDescUpdatedAt := walletderivationcursorMixinFields0[1].Descriptor()
	// walletderivationcursor.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	walletderivationcursor.DefaultUpdatedAt = walletderivationcursorDescUpdatedAt.Default.(func() time.Time)
	// walletderivationcursor.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	walletderivationcursor.UpdateDefaultUpdatedAt = walletderivationcursorDescUpdatedAt.UpdateDefault.(func() time.Time)
	// walletderivationcursorDescNetwork is the schema descriptor for network field.
	walletderivationcursorDescNetwork := walletderivationcursorFields[0].Descriptor()
	// walletderivationcursor.NetworkValidator is a validator for the "network" field. It is called by the builders before save.
	walletderivationcursor.NetworkValidator = walletderivationcursorDescNetwork.Validators[0].(func(string) error)
	// walletderivationcursorDescNextIndex is the schema descriptor for next_index field.
	walletderivationcursorDescNextIndex := walletderivationcursorFields[1].Descriptor()
	// walletderivationcursor.DefaultNextIndex holds the default value on creation for the next_index field.
	walletderivationcursor.DefaultNextIndex = walletderivationcursorDescNextIndex.Default.(int64)
	// walletderivationcursor.NextIndexValidator is a validator for the "next_index" field. It is called by the builders before save.
	walletderivationcursor.NextIndexValidator = walletderivationcursorDescNextIndex.Validators[0].(func(int64) error)
	// walletderivationcursorDescVersion is the schema descriptor for version field.
	walletderivationcursorDescVersion := walletderivationcursorFields[2].Descriptor()
	// walletderivationcursor.DefaultVersion holds the default value on creation for the version field.
	walletderivationcursor.DefaultVersion = walletderivationcursorDescVersion.Default.(int)
	// walletderivationcursor.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	walletderivationcursor.VersionValidator = walletderivationcursorDescVersion.Validators[0].(func(int) error)
	walletsweepMixin := schema.WalletSweep{}.Mixin()
	walletsweepMixinFields0 := walletsweepMixin[0].Fields()
	_ = walletsweepMixinFields0
	walletsweepFields := schema.WalletSweep{}.Fields()
	_ = walletsweepFields
	// walletsweepDescCreatedAt is the schema descriptor for created_at field.
	walletsweepDescCreatedAt := walletsweepMixinFields0[0].Descriptor()
	// walletsweep.DefaultCreatedAt holds the default value on creation for the created_at field.
	walletsweep.DefaultCreatedAt = walletsweepDescCreatedAt.Default.(func() time.Time)
	// walletsweepDescUpdatedAt is the schema descriptor for updated_at field.
	walletsweepDescUpdatedAt := walletsweepMixinFields0[1].Descriptor()
	// walletsweep.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	walletsweep.DefaultUpdatedAt = walletsweepDescUpdatedAt.Default.(func() time.Time)
	// walletsweep.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	walletsweep.UpdateDefaultUpdatedAt = walletsweepDescUpdatedAt.UpdateDefault.(func() time.Time)
	// walletsweepDescIntentID is the schema descriptor for intent_id field.
	walletsweepDescIntentID := walletsweepFields[0].Descriptor()
	// walletsweep.IntentIDValidator is a validator for the "intent_id" field. It is called by the builders before save.
	walletsweep.IntentIDValidator = walletsweepDescIntentID.Validators[0].(func(int64) error)
	// walletsweepDescNetwork is the schema descriptor for network field.
	walletsweepDescNetwork := walletsweepFields[1].Descriptor()
	// walletsweep.NetworkValidator is a validator for the "network" field. It is called by the builders before save.
	walletsweep.NetworkValidator = walletsweepDescNetwork.Validators[0].(func(string) error)
	// walletsweepDescChainID is the schema descriptor for chain_id field.
	walletsweepDescChainID := walletsweepFields[2].Descriptor()
	// walletsweep.ChainIDValidator is a validator for the "chain_id" field. It is called by the builders before save.
	walletsweep.ChainIDValidator = walletsweepDescChainID.Validators[0].(func(int64) error)
	// walletsweepDescSourceAddress is the schema descriptor for source_address field.
	walletsweepDescSourceAddress := walletsweepFields[3].Descriptor()
	// walletsweep.SourceAddressValidator is a validator for the "source_address" field. It is called by the builders before save.
	walletsweep.SourceAddressValidator = walletsweepDescSourceAddress.Validators[0].(func(string) error)
	// walletsweepDescDestinationAddress is the schema descriptor for destination_address field.
	walletsweepDescDestinationAddress := walletsweepFields[4].Descriptor()
	// walletsweep.DestinationAddressValidator is a validator for the "destination_address" field. It is called by the builders before save.
	walletsweep.DestinationAddressValidator = walletsweepDescDestinationAddress.Validators[0].(func(string) error)
	// walletsweepDescIdempotencyKey is the schema descriptor for idempotency_key field.
	walletsweepDescIdempotencyKey := walletsweepFields[7].Descriptor()
	// walletsweep.IdempotencyKeyValidator is a validator for the "idempotency_key" field. It is called by the builders before save.
	walletsweep.IdempotencyKeyValidator = walletsweepDescIdempotencyKey.Validators[0].(func(string) error)
	// walletsweepDescSignerRequestDigest is the schema descriptor for signer_request_digest field.
	walletsweepDescSignerRequestDigest := walletsweepFields[8].Descriptor()
	// walletsweep.SignerRequestDigestValidator is a validator for the "signer_request_digest" field. It is called by the builders before save.
	walletsweep.SignerRequestDigestValidator = walletsweepDescSignerRequestDigest.Validators[0].(func(string) error)
	// walletsweepDescSignerAuditID is the schema descriptor for signer_audit_id field.
	walletsweepDescSignerAuditID := walletsweepFields[9].Descriptor()
	// walletsweep.SignerAuditIDValidator is a validator for the "signer_audit_id" field. It is called by the builders before save.
	walletsweep.SignerAuditIDValidator = walletsweepDescSignerAuditID.Validators[0].(func(string) error)
	// walletsweepDescTransactionID is the schema descriptor for transaction_id field.
	walletsweepDescTransactionID := walletsweepFields[10].Descriptor()
	// walletsweep.TransactionIDValidator is a validator for the "transaction_id" field. It is called by the builders before save.
	walletsweep.TransactionIDValidator = walletsweepDescTransactionID.Validators[0].(func(string) error)
	// walletsweepDescNonce is the schema descriptor for nonce field.
	walletsweepDescNonce := walletsweepFields[11].Descriptor()
	// walletsweep.NonceValidator is a validator for the "nonce" field. It is called by the builders before save.
	walletsweep.NonceValidator = walletsweepDescNonce.Validators[0].(func(int64) error)
	// walletsweepDescReplacementOfID is the schema descriptor for replacement_of_id field.
	walletsweepDescReplacementOfID := walletsweepFields[12].Descriptor()
	// walletsweep.ReplacementOfIDValidator is a validator for the "replacement_of_id" field. It is called by the builders before save.
	walletsweep.ReplacementOfIDValidator = walletsweepDescReplacementOfID.Validators[0].(func(int64) error)
	// walletsweepDescFeeRaw is the schema descriptor for fee_raw field.
	walletsweepDescFeeRaw := walletsweepFields[13].Descriptor()
	// walletsweep.DefaultFeeRaw holds the default value on creation for the fee_raw field.
	walletsweep.DefaultFeeRaw = walletsweepDescFeeRaw.Default.(string)
	// walletsweepDescEnergyUsed is the schema descriptor for energy_used field.
	walletsweepDescEnergyUsed := walletsweepFields[14].Descriptor()
	// walletsweep.DefaultEnergyUsed holds the default value on creation for the energy_used field.
	walletsweep.DefaultEnergyUsed = walletsweepDescEnergyUsed.Default.(int64)
	// walletsweep.EnergyUsedValidator is a validator for the "energy_used" field. It is called by the builders before save.
	walletsweep.EnergyUsedValidator = walletsweepDescEnergyUsed.Validators[0].(func(int64) error)
	// walletsweepDescBandwidthUsed is the schema descriptor for bandwidth_used field.
	walletsweepDescBandwidthUsed := walletsweepFields[15].Descriptor()
	// walletsweep.DefaultBandwidthUsed holds the default value on creation for the bandwidth_used field.
	walletsweep.DefaultBandwidthUsed = walletsweepDescBandwidthUsed.Default.(int64)
	// walletsweep.BandwidthUsedValidator is a validator for the "bandwidth_used" field. It is called by the builders before save.
	walletsweep.BandwidthUsedValidator = walletsweepDescBandwidthUsed.Validators[0].(func(int64) error)
	// walletsweepDescFinalizedBlockHeight is the schema descriptor for finalized_block_height field.
	walletsweepDescFinalizedBlockHeight := walletsweepFields[16].Descriptor()
	// walletsweep.FinalizedBlockHeightValidator is a validator for the "finalized_block_height" field. It is called by the builders before save.
	walletsweep.FinalizedBlockHeightValidator = walletsweepDescFinalizedBlockHeight.Validators[0].(func(int64) error)
	// walletsweepDescFinalizedBlockHash is the schema descriptor for finalized_block_hash field.
	walletsweepDescFinalizedBlockHash := walletsweepFields[17].Descriptor()
	// walletsweep.FinalizedBlockHashValidator is a validator for the "finalized_block_hash" field. It is called by the builders before save.
	walletsweep.FinalizedBlockHashValidator = walletsweepDescFinalizedBlockHash.Validators[0].(func(string) error)
	// walletsweepDescStatus is the schema descriptor for status field.
	walletsweepDescStatus := walletsweepFields[18].Descriptor()
	// walletsweep.DefaultStatus holds the default value on creation for the status field.
	walletsweep.DefaultStatus = walletsweepDescStatus.Default.(string)
	// walletsweep.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	walletsweep.StatusValidator = walletsweepDescStatus.Validators[0].(func(string) error)
	// walletsweepDescRetryCount is the schema descriptor for retry_count field.
	walletsweepDescRetryCount := walletsweepFields[19].Descriptor()
	// walletsweep.DefaultRetryCount holds the default value on creation for the retry_count field.
	walletsweep.DefaultRetryCount = walletsweepDescRetryCount.Default.(int)
	// walletsweep.RetryCountValidator is a validator for the "retry_count" field. It is called by the builders before save.
	walletsweep.RetryCountValidator = walletsweepDescRetryCount.Validators[0].(func(int) error)
	// walletsweepDescFailureCode is the schema descriptor for failure_code field.
	walletsweepDescFailureCode := walletsweepFields[20].Descriptor()
	// walletsweep.FailureCodeValidator is a validator for the "failure_code" field. It is called by the builders before save.
	walletsweep.FailureCodeValidator = walletsweepDescFailureCode.Validators[0].(func(string) error)
	// walletsweepDescVersion is the schema descriptor for version field.
	walletsweepDescVersion := walletsweepFields[24].Descriptor()
	// walletsweep.DefaultVersion holds the default value on creation for the version field.
	walletsweep.DefaultVersion = walletsweepDescVersion.Default.(int)
	// walletsweep.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	walletsweep.VersionValidator = walletsweepDescVersion.Validators[0].(func(int) error)
}
