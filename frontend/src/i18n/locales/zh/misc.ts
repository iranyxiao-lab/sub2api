export default {
  ...
  payment: {
    ...
    onchain: {
      sendExactAmount: '请仅通过 {network} 向该订单地址转入准确的 USDT 金额',
      amount: 'USDT 金额（{network}）',
      address: '充值地址',
      receivedAmount: '已到账',
      pendingAmount: '待补金额',
      copyAmount: '复制金额',
      ...
      addressQrHint: '二维码仅包含完整充值地址',
      trc20RiskWarning: '仅可通过 TRON 主网（TRC20）转入 USDT。其他网络转入无法自动入账，并可能需要人工处理。',
      erc20RiskWarning: '仅可通过 Ethereum 主网（ERC20）转入 USDT。其他网络转入无法自动入账，并可能需要人工处理。',
      status: {
        pending: '等待支付',
        partial: '部分到账',
        processing: '链上支付处理中',
      ...
      statusHint: {
        pending: '检测到已固化转账后，本页面会自动刷新。',
        partial: '请继续向同一地址转入待补金额。',
        processing: '已检测到固化付款，正在完成余额入账。',
        review: '已检测到过期付款或异常资金，请勿再次转账，等待人工处理。',
        expired: '该地址仍永久绑定本订单，迟到转账会继续被检测并按复核规则处理。',
        unavailable: '充值地址仍然有效，自动刷新会继续重试且不会改变支付信息。',
      },
    },
    orders: {
      title: '我的订单',
    ...
    tabSubscribe: '订阅',
    noPlans: '暂无可用订阅套餐',
    noSubscriptionPaymentMethods: '当前没有可用于订阅的支付方式',
    ...
    errors: {
      ...
      onchainBalanceRechargeOnly: 'USDT（TRC20/ERC20）仅支持余额充值，不能用于购买或续费订阅。',
    ...
    admin: {
      ...
      confirmRefund: '确认退款',
      createRefundReview: '创建人工复核',
      onchainRefundManualOnly: '禁止自动链上退款。提交后只会创建待人工审核记录，不会签名或广播任何交易。',
      manualReviewPending: '待人工复核',
      refundReviewCreated: '链上退款人工复核记录已创建',
      refundSuccess: '退款成功',
      ...
      auditLogs: '操作日志',
      operator: '操作人',
      onchainOperations: '链上运营',
      onchainDeposits: '链上充值流水',
      manualReviewQueue: '人工复核队列',
      manualReview: '人工复核',
      noOnchainHealth: '暂无链上健康记录',
      noOnchainDeposits: '暂无符合条件的链上流水',
      allNetworks: '全部网络',
      network: '网络',
      chainId: '链 ID',
      nodeHeights: 'Full / 固化高度',
      ethereumNodeHeights: '主 / 备节点高度',
      nodeBlockLag: '节点高度差',
      finalizedLag: 'Finalized 延迟',
      scanHeight: '扫描高度',
      scanLag: '扫描延迟（区块 / 时间）',
      lastScan: '最近扫描',
      pendingSettlement: '待结算',
      reconciliationMismatches: '对账差异',
      unsweptBalance: '未归集余额',
      resourceWaitSweeps: '资源等待',
      tronResources: 'TRX / Energy / Bandwidth',
      signerHealth: 'Signer 健康',
      sweepFailuresRetries: '失败 / 重试',
      ethereumPendingTransactions: '待确认交易 / 最长等待',
      ethereumNonce: 'Pending nonce / 冲突',
      ethereumReplacements: '替换交易数',
      ethereumGasSponsor: 'Gas 赞助余额',
      ethereumGasCost: '已固化 Gas 成本',
      onchainAlert: {
        node_unsynced: '节点不同步',
        hash_conflict: '固化区块哈希冲突',
        scan_stalled: '扫描停滞',
        settlement_backlog: '结算积压',
        resource_insufficient: 'TRON 资源不足',
        sweep_consecutive_failures: '归集连续失败',
        signer_unavailable: 'Signer 不可用',
        hot_wallet_limit: '热钱包超限',
        reconciliation_mismatch: '链上余额对账差异',
        node_divergence: 'Ethereum 主备节点分歧',
        rpc_errors: 'Ethereum RPC 错误',
        finalized_delay: 'Finalized 区块延迟',
        eth_low: 'Gas 赞助 ETH 不足',
        pending_nonce: 'Pending nonce 积压',
        nonce_conflict: 'Nonce 冲突',
        transaction_stuck: '交易卡住',
        transaction_replacements: '发生替换交易',
        unswept_usdt: '未归集 USDT 积压',
        gas_cost_high: 'Gas 成本达到阈值',
      },
      healthy: '健康',
      attentionRequired: '需要关注',
      hotWalletBalance: '热钱包余额',
      automaticSweeps: '自动归集',
      active: '运行中',
      paused: '已暂停',
      hotWalletWarning: '热钱包余额已达到 {amount} USDT 预警阈值。',
      coldTransferApprovalRequired: '余额已达到 {amount} USDT，自动归集已暂停，需通过独立冷钱包转移审批流程处理。',
      transactionId: '交易号',
      chainAddress: '链上地址',
      orderIdFilter: '订单 ID',
      transactionLog: '交易 / 日志',
      orderUser: '订单 / 用户',
      block: '区块',
      fundTrace: '链上资金链路',
      intentStatus: '结算状态',
      expectedAmount: '预期金额',
      receivedAmount: '到账金额',
      creditedOnchainAmount: '已入账链上金额',
      depositAddress: '充值地址',
      tokenContract: '代币合约',
      walletSweeps: '钱包归集',
      gasFundings: 'Ethereum Gas 补给',
      nonceStates: 'Ethereum Nonce 状态',
      nextObservedNonce: '下一 nonce / 节点 pending nonce',
      receipt: '交易回执',
      success: '成功',
      failed: '失败',
      onchainStatus: {
