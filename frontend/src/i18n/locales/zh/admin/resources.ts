export default {
    intelligence: {
      settings: '测试设置',
      notConfigured: '尚未配置测试',
      scheduleOn: '定时测试',
      scheduleOff: '定时未启用',
      submitting: '正在提交…',
      filterStatus: '筛选执行状态',
      refresh: '刷新',
      historyLoadFailed: '历史记录加载失败，已显示的记录仍保留，请重试。',
      setupHint: '选择模型和提示词后即可开始测试。',
      configure: '配置测试',
      noMatches: '没有符合筛选条件的记录',
      noRuns: '尚未执行过测试',
      firstRunHint: '开始测试后会立即生成记录，关闭窗口也会继续执行。',
      modelsUnavailable: '模型列表暂不可用；已保存的模型仍可使用。',
      bankLoadFailed: '题库加载失败',
      frequency: '执行频率',
      scheduleHint: 'Cron 使用服务器配置的时区，执行间隔至少 15 分钟；下次执行时间按本地时区显示。',
      saveAndRun: '保存并开始',
      bankHint: '只需标题和提示词，无需设置答案或评分。',
      allStatuses: '全部状态',
      state_queued: '排队中',
      state_running: '执行中',
      state_success: '已完成',
      ...
      trigger_legacy: '历史记录',
      backgroundHint: '任务在后台执行，可关闭窗口后再查看。',
      technicalDetails: '技术详情',
      partialOutput: '回答未完成，以下为已收到的部分内容。',
      truncatedOutput: '回答超过保留上限，内容已截断。',
      source: '源码',
      output: '回答',
      copyOutput: '复制回答',
      expand: '放大查看',
      emptyOutput: '模型未返回文本内容',
      viewPrompt: '查看完整提示词',
      retryRun: '重新测试',
      executionLimit: '上限 {seconds} 秒',
      error_execution_timeout: '测试执行超时（{seconds} 秒），可稍后重试。',
      error_queue_timeout: '排队超过 10 分钟，请重新测试。',
      error_worker_interrupted: '测试执行已中断，请手动重新测试。',
      error_upstream_error: '模型调用失败，请查看技术详情。',
      copied: '回答已复制',
      copyFailed: '复制失败，请手动选择文本复制。',
      title: '智力测试', bank: '题库', addQuestion: '添加题目', questionTitle: '标题', prompt: '题目提示词',
      customPrompt: '账号专属提示词', selectQuestions: '选择题目（单选）',
      currentSelectionHint: '每次测试使用一题。立即测试会先保存当前设置，再按所选题目执行；定时测试也使用保存后的设置。',
      chooseSingleQuestion: '此计划原来配置了多道题，请明确选择一道题后再保存或测试。',
      pendingSubmission: '上一次提交尚未确认。请先恢复原设置并重试该请求，确认结果后再更换题目，避免重复执行。',
      manageBank: '管理题库', selectModel: '选择模型', runNow: '立即测试', history: '历史结果',
      details: '详情', preview: '静态 HTML 预览', confirmDelete: '删除这道题目？',
