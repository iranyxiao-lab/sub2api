...
const (
	...
	EdgeUser = "user"
	// EdgeOnchainPaymentIntent holds the string denoting the onchain_payment_intent edge name in mutations.
	EdgeOnchainPaymentIntent = "onchain_payment_intent"
	...
	UserColumn = "user_id"
	// OnchainPaymentIntentTable is the table that holds the onchain_payment_intent relation/edge.
	OnchainPaymentIntentTable = "onchain_payment_intents"
	// OnchainPaymentIntentInverseTable is the table name for the OnchainPaymentIntent entity.
	// It exists in this package in order to avoid circular dependency with the "onchainpaymentintent" package.
	OnchainPaymentIntentInverseTable = "onchain_payment_intents"
	// OnchainPaymentIntentColumn is the table column denoting the onchain_payment_intent relation/edge.
	OnchainPaymentIntentColumn = "payment_order_id"
)
...
// ByOnchainPaymentIntentField orders the results by onchain_payment_intent field.
func ByOnchainPaymentIntentField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newOnchainPaymentIntentStep(), sql.OrderByField(field, opts...))
	}
}
...
func newOnchainPaymentIntentStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(OnchainPaymentIntentInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2O, false, OnchainPaymentIntentTable, OnchainPaymentIntentColumn),
	)
}
