...
func (_c *PaymentOrderCreate) SetOnchainPaymentIntentID(id int64) *PaymentOrderCreate {
	_c.mutation.SetOnchainPaymentIntentID(id)
	return _c
}
...
func (_c *PaymentOrderCreate) SetNillableOnchainPaymentIntentID(id *int64) *PaymentOrderCreate {
	if id != nil {
		_c = _c.SetOnchainPaymentIntentID(*id)
	}
	return _c
}

// SetOnchainPaymentIntent sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity.
func (_c *PaymentOrderCreate) SetOnchainPaymentIntent(v *OnchainPaymentIntent) *PaymentOrderCreate {
	return _c.SetOnchainPaymentIntentID(v.ID)
}
...
func (_c *PaymentOrderCreate) createSpec() (*PaymentOrder, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.OnchainPaymentIntentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
