...
// HasOnchainPaymentIntent applies the HasEdge predicate on the "onchain_payment_intent" edge.
func HasOnchainPaymentIntent() predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOnchainPaymentIntentWith applies the HasEdge predicate on the "onchain_payment_intent" edge with a given conditions (other predicates).
func HasOnchainPaymentIntentWith(preds ...predicate.OnchainPaymentIntent) predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
		step := newOnchainPaymentIntentStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
