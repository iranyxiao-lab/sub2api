...
func (s *AccountTestService) testCNProviderAdaptiveResponsesConnection(c *gin.Context, account *Account, testModelID string, authToken string, customPrompt ...string) error {
	ctx := c.Request.Context()
	...
	payload := createOpenAITestPayload(testModelID, false, customPrompt...)
