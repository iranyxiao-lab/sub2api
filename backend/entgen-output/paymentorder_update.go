...
// SetOnchainPaymentIntentID sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity by ID.
func (_u *PaymentOrderUpdate) SetOnchainPaymentIntentID(id int64) *PaymentOrderUpdate {
	_u.mutation.SetOnchainPaymentIntentID(id)
	return _u
}

// SetNillableOnchainPaymentIntentID sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity by ID if the given value is not nil.
func (_u *PaymentOrderUpdate) SetNillableOnchainPaymentIntentID(id *int64) *PaymentOrderUpdate {
	if id != nil {
		_u = _u.SetOnchainPaymentIntentID(*id)
	}
	return _u
}

// SetOnchainPaymentIntent sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity.
func (_u *PaymentOrderUpdate) SetOnchainPaymentIntent(v *OnchainPaymentIntent) *PaymentOrderUpdate {
	return _u.SetOnchainPaymentIntentID(v.ID)
}
...
// ClearOnchainPaymentIntent clears the "onchain_payment_intent" edge to the OnchainPaymentIntent entity.
func (_u *PaymentOrderUpdate) ClearOnchainPaymentIntent() *PaymentOrderUpdate {
	_u.mutation.ClearOnchainPaymentIntent()
	return _u
}
...
func (_u *PaymentOrderUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.OnchainPaymentIntentCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   paymentorder.OnchainPaymentIntentTable,
			Columns: []string{paymentorder.OnchainPaymentIntentColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.OnchainPaymentIntentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   paymentorder.OnchainPaymentIntentTable,
...
// SetOnchainPaymentIntentID sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity by ID.
func (_u *PaymentOrderUpdateOne) SetOnchainPaymentIntentID(id int64) *PaymentOrderUpdateOne {
	_u.mutation.SetOnchainPaymentIntentID(id)
	return _u
}

// SetNillableOnchainPaymentIntentID sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity by ID if the given value is not nil.
func (_u *PaymentOrderUpdateOne) SetNillableOnchainPaymentIntentID(id *int64) *PaymentOrderUpdateOne {
	if id != nil {
		_u = _u.SetOnchainPaymentIntentID(*id)
	}
	return _u
...
// SetOnchainPaymentIntent sets the "onchain_payment_intent" edge to the OnchainPaymentIntent entity.
func (_u *PaymentOrderUpdateOne) SetOnchainPaymentIntent(v *OnchainPaymentIntent) *PaymentOrderUpdateOne {
	return _u.SetOnchainPaymentIntentID(v.ID)
}
...
// ClearOnchainPaymentIntent clears the "onchain_payment_intent" edge to the OnchainPaymentIntent entity.
func (_u *PaymentOrderUpdateOne) ClearOnchainPaymentIntent() *PaymentOrderUpdateOne {
	_u.mutation.ClearOnchainPaymentIntent()
	return _u
}
