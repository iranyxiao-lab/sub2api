export default {
  ...
  payment: {
    ...
    onchain: {
      sendExactAmount: 'Send the exact USDT amount through {network} to this order address',
      amount: 'USDT amount ({network})',
      address: 'Deposit address',
      receivedAmount: 'Received',
      pendingAmount: 'Still due',
      copyAmount: 'Copy amount',
      copyAddress: 'Copy address',
      copied: 'Copied',
      copyFailed: 'Copy failed. Please select and copy the value manually.',
      addressQrHint: 'The QR code contains only the complete deposit address',
      trc20RiskWarning: 'Only send USDT through the TRON mainnet (TRC20). Transfers from any other network cannot be credited automatically and may require manual review.',
      erc20RiskWarning: 'Only send USDT through the Ethereum mainnet (ERC20). Transfers from any other network cannot be credited automatically and may require manual review.',
      status: {
        pending: 'Waiting for payment',
        partial: 'Partially paid',
        processing: 'Processing on-chain payment',
        review: 'Manual review required',
        expired: 'Order expired',
        unavailable: 'Status temporarily unavailable',
      },
      statusHint: {
        pending: 'This page refreshes automatically after a finalized transfer is detected.',
        partial: 'Send the remaining amount to the same address before leaving this order.',
        processing: 'The finalized payment was detected and balance crediting is in progress.',
        review: 'Funds were detected after expiry or require manual handling. Do not send another transfer.',
        expired: 'The address remains bound to this order. Late transfers will be detected and handled according to review rules.',
        unavailable: 'The address remains valid. Automatic status refresh will retry without changing the payment details.',
      },
    },
    orders: {
      title: 'My Orders',
    ...
    noSubscriptionPaymentMethods: 'No payment method is currently available for subscriptions',
    ...
    errors: {
      ...
      onchainBalanceRechargeOnly: 'USDT (TRC20/ERC20) can only be used for balance top-up.',
    ...
    admin: {
      ...
      createRefundReview: 'Create Manual Review',
      onchainRefundManualOnly: 'Automatic on-chain refunds are prohibited. Submitting creates a pending manual review record only; no transaction will be signed or broadcast.',
      manualReviewPending: 'Manual review pending',
      refundReviewCreated: 'Manual on-chain refund review created',
      ...
      operator: 'Operator',
      onchainOperations: 'On-chain Operations',
      onchainDeposits: 'On-chain Deposits',
      manualReviewQueue: 'Manual Review Queue',
      manualReview: 'Manual Review',
      noOnchainHealth: 'No on-chain health record',
      noOnchainDeposits: 'No matching on-chain deposits',
      allNetworks: 'All Networks',
      network: 'Network',
      chainId: 'Chain ID',
      nodeHeights: 'Full / Solid Height',
      ethereumNodeHeights: 'Primary / Backup Height',
      nodeBlockLag: 'Node Block Lag',
      finalizedLag: 'Finalized Lag',
      scanHeight: 'Scan Height',
      scanLag: 'Scan Lag (blocks / time)',
      lastScan: 'Last Scan',
      pendingSettlement: 'Pending Settlement',
      reconciliationMismatches: 'Reconciliation Mismatches',
      unsweptBalance: 'Unswept Balance',
      resourceWaitSweeps: 'Resource Wait',
      tronResources: 'TRX / Energy / Bandwidth',
      signerHealth: 'Signer Health',
      sweepFailuresRetries: 'Failures / Retries',
      ethereumPendingTransactions: 'Pending / Oldest Age',
      ethereumNonce: 'Pending Nonce / Conflicts',
      ethereumReplacements: 'Replacement Transactions',
      ethereumGasSponsor: 'Gas Sponsor Balance',
      ethereumGasCost: 'Finalized Gas Cost',
      onchainAlert: {
        node_unsynced: 'Node unsynced',
        hash_conflict: 'Finalized hash conflict',
        scan_stalled: 'Scanner stalled',
        settlement_backlog: 'Settlement backlog',
        resource_insufficient: 'TRON resources insufficient',
        sweep_consecutive_failures: 'Consecutive sweep failures',
        signer_unavailable: 'Signer unavailable',
        hot_wallet_limit: 'Hot wallet limit',
        reconciliation_mismatch: 'Balance reconciliation mismatch',
        node_divergence: 'Ethereum node divergence',
        rpc_errors: 'Ethereum RPC errors',
        finalized_delay: 'Finalized block delayed',
        eth_low: 'Gas sponsor ETH low',
        pending_nonce: 'Pending nonce backlog',
        nonce_conflict: 'Nonce conflict',
        transaction_stuck: 'Transaction stuck',
        transaction_replacements: 'Replacement transactions',
        unswept_usdt: 'Unswept USDT backlog',
        gas_cost_high: 'Gas cost threshold reached',
      },
      healthy: 'Healthy',
      attentionRequired: 'Attention Required',
      hotWalletBalance: 'Hot Wallet Balance',
      automaticSweeps: 'Automatic Sweeps',
      active: 'Active',
      paused: 'Paused',
      hotWalletWarning: 'Hot wallet balance reached the {amount} USDT warning threshold.',
      coldTransferApprovalRequired: 'Balance reached {amount} USDT. Automatic sweeps are paused pending an independent cold-wallet transfer approval.',
      ...
      block: 'Block',
      fundTrace: 'On-chain Fund Trace',
      intentStatus: 'Settlement Status',
      expectedAmount: 'Expected Amount',
      receivedAmount: 'Received Amount',
      creditedOnchainAmount: 'Credited On-chain Amount',
      depositAddress: 'Deposit Address',
      tokenContract: 'Token Contract',
      walletSweeps: 'Wallet Sweeps',
      gasFundings: 'Ethereum Gas Fundings',
      nonceStates: 'Ethereum Nonce States',
      nextObservedNonce: 'Next / Observed Pending Nonce',
      receipt: 'Receipt',
      success: 'Success',
      failed: 'Failed',
      onchainStatus: {
