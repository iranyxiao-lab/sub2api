export default {
    intelligence: {
      ...
      notConfigured: 'Test not configured',
      scheduleOn: 'Scheduled tests',
      scheduleOff: 'Schedule disabled',
      submitting: 'Submitting…',
      filterStatus: 'Filter run status',
      refresh: 'Refresh',
      historyLoadFailed: 'Unable to refresh history. Previously loaded records are preserved.',
      setupHint: 'Select a model and prompts to start testing.',
      configure: 'Configure test',
      noMatches: 'No matching records',
      noRuns: 'No tests have been run yet',
      firstRunHint: 'Starting a test creates a record immediately. Execution continues after closing this window.',
      modelsUnavailable: 'Model list unavailable. The saved model remains usable.',
      bankLoadFailed: 'Failed to load question bank',
      frequency: 'Frequency',
      scheduleHint: 'Cron uses the server time zone with at least 15 minutes between runs. Next run is shown in your local time zone.',
      saveAndRun: 'Save and start',
      bankHint: 'Only a title and prompt are required. No expected answers or scores.',
      ...
      backgroundHint: 'Running in the background. You can close this window.',
      technicalDetails: 'Technical details',
      partialOutput: 'Incomplete response. Showing the text received so far.',
      truncatedOutput: 'Response exceeded the retention limit and was truncated.',
      source: 'Source',
      output: 'Response',
      copyOutput: 'Copy response',
      expand: 'Expand',
      emptyOutput: 'The model returned no text',
      viewPrompt: 'View full prompt',
      retryRun: 'Run again',
      executionLimit: 'Limit {seconds}s',
      error_execution_timeout: 'Test timed out after {seconds} seconds. You can retry.',
      error_queue_timeout: 'Queue wait exceeded 10 minutes. Please retry.',
      error_worker_interrupted: 'Execution was interrupted. Please retry manually.',
      error_upstream_error: 'Model call failed. See technical details.',
      copied: 'Response copied',
      copyFailed: 'Copy failed. Please select and copy the text manually.',
      title: 'Intelligence test', bank: 'Question bank', addQuestion: 'Add question', questionTitle: 'Title', prompt: 'Question prompt',
      customPrompt: 'Account-specific instructions', selectQuestions: 'Question (choose one)',
      currentSelectionHint: 'Each test uses one question. Run now saves current settings before running the selected question; scheduled tests use those saved settings too.',
      chooseSingleQuestion: 'This plan previously selected multiple questions. Choose one explicitly before saving or running.',
      pendingSubmission: 'The previous submission is unconfirmed. Restore its settings and retry that request before changing the question to avoid duplicate execution.',
      manageBank: 'Manage question bank', selectModel: 'Select model', runNow: 'Run now', history: 'History',
      details: 'Details', preview: 'Static HTML preview', confirmDelete: 'Delete this question?',
