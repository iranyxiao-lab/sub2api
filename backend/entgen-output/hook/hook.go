...
// The ChainScanCursorFunc type is an adapter to allow the use of ordinary
// function as ChainScanCursor mutator.
type ChainScanCursorFunc func(context.Context, *ent.ChainScanCursorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ChainScanCursorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ChainScanCursorMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ChainScanCursorMutation", m)
}
...
// The EthereumGasFundingFunc type is an adapter to allow the use of ordinary
// function as EthereumGasFunding mutator.
type EthereumGasFundingFunc func(context.Context, *ent.EthereumGasFundingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f EthereumGasFundingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EthereumGasFundingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.EthereumGasFundingMutation", m)
}

// The EthereumNonceStateFunc type is an adapter to allow the use of ordinary
// function as EthereumNonceState mutator.
type EthereumNonceStateFunc func(context.Context, *ent.EthereumNonceStateMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f EthereumNonceStateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EthereumNonceStateMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.EthereumNonceStateMutation", m)
}
...
// The OnchainPaymentIntentFunc type is an adapter to allow the use of ordinary
// function as OnchainPaymentIntent mutator.
type OnchainPaymentIntentFunc func(context.Context, *ent.OnchainPaymentIntentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OnchainPaymentIntentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OnchainPaymentIntentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OnchainPaymentIntentMutation", m)
}
...
// The WalletDerivationCursorFunc type is an adapter to allow the use of ordinary
// function as WalletDerivationCursor mutator.
type WalletDerivationCursorFunc func(context.Context, *ent.WalletDerivationCursorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WalletDerivationCursorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WalletDerivationCursorMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WalletDerivationCursorMutation", m)
}

// The WalletSweepFunc type is an adapter to allow the use of ordinary
// function as WalletSweep mutator.
type WalletSweepFunc func(context.Context, *ent.WalletSweepMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WalletSweepFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WalletSweepMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WalletSweepMutation", m)
}
